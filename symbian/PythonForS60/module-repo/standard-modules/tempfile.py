...
if _os.name != 'posix' or _os.sys.platform == 'cygwin' or _os.sys.platform == 'symbian_s60':
    # On non-POSIX Cygwin systems and Symbian, assume that we cannot unlink a file
    # while it is open.
